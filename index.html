...
<html lang="en">
  ...
  <head>
    ...
    <title>Games Design Programming</title>
  ...
  <body id="page-top">
      ...
      <div class="container">
        ...
        <div class="collapse navbar-collapse" id="navbarResponsive">
          <ul class="navbar-nav text-uppercase ml-auto">
            ...
            <li class="nav-item">
              <a class="nav-link js-scroll-trigger" href="#about">Juego</a>
            </li>
            <li class="nav-item">
              <a class="nav-link js-scroll-trigger" href="#team">Equipo</a>
            </li>
            <li class="nav-item">
              <a class="nav-link js-scroll-trigger" href="#contactos">Contactar</a>
            </li>
          </ul>
        </div>
      </div>
    ...
    <header class="masthead">
      <div class="container">
        <div class="intro-text">
          <div class="intro-lead-in">Nuestro nuevo juego ya disponible</div>
          <div class="intro-heading text-uppercase">¡Run to hell sweet!</div>
          <a class="btn btn-primary btn-xl text-uppercase js-scroll-trigger" href="#about">Leer más</a>
        </div>
      </div>
    </header>
        ...
        <div class="row">
          <div class="col-md-4 col-sm-6 portfolio-item">
            <a class="portfolio-link" data-toggle="modal" href="#portfolioModal1">
              ...
              <img class="img-fluid" src="img/portfolio/2018-04-16 (4).png" width="800" height="600" alt="">
            </a>
          ...
          <div class="col-md-4 col-sm-6 portfolio-item">
            <a class="portfolio-link" data-toggle="modal" href="#portfolioModal2">
              ...
              <img class="img-fluid" src="img/portfolio/game.jpg" width="800" height="600" alt="">
            </a>
            <div class="portfolio-caption">
              <h4>Diseño</h4>
          ...
          <div class="col-md-4 col-sm-6 portfolio-item">
            <a class="portfolio-link" data-toggle="modal" href="#portfolioModal3">
              ...
              <img class="img-fluid" src="img/portfolio/2018-04-16 (2).png" alt="">
            </a>
            <div class="portfolio-caption">
    ...
    <section id="about">
      <div class="container">
        <div class="row">
          <div class="col-lg-12 text-center">
            <h2 class="section-heading text-uppercase">Nuestro primer videojuego</h2>
            <h3 class="section-subheading text-muted">Run to hell sweet.</h3>
          </div>
        </div>
        <div class="row">
          <div class="col-lg-12">
            <ul class="timeline">
                ...
                <div class="timeline-panel">
                  ...
                  <div class="timeline-body">
                    <p class="text-muted">Todo empezó con un sueño de poder crear nuestro propio videojuego
                      utilizando todos los conocimientos que recabamos durante nuestro universidad, logrando de esta manera poder juntar 3 áreas diferentes que desarrollamos de manera individual siendo las áreas de desarollo de videojuegos, diseño y programación orientada en videojuegos.
                      </p>
                  </div>
                </div>
                <br>
              ...
              <li class="timeline-inverted">
                <div class="timeline-image">
                  <img class="img" src="img/about/1.png" alt="" width="115%" height="115%">   
                </div>
                <div class="timeline-panel">
                  <div class="timeline-heading">
                    Historia
                    <br>"Run to hell sweet"</h4>
                    
                  </div>
                  <div class="timeline-body">
                    <p class="text-muted">Es un candyman que vive en una aldea de dulce amenamente, él cosecha sunchos en el bosque
              ...
              <li>
                ...
                <div class="timeline-panel">
                  <div class="timeline-heading">
                    <h4 class="subheading">El desarrollo</h4>
                  </div>
                  <div class="timeline-body">
                    <p class="text-muted">El desarrollo del juego fue algo extenso ya que nos llevó a una lluvia de ideas bastante creativas para previa visualización, dado que no teníamos biel plan de que hacer.</p>
                  </div>
                </div>
              <li class="timeline-inverted">
                <div class="timeline-image">
      ...
      <div class="container">
        <div class="row">
          <div class="col-md-12 text-center">
            <h3>Aquí puedes descargar nuestro juego</h3>
            <br>  
          </br>
            <a class="btn btn-primary btn-x2 text-uppercase js-scroll-trigger" href="http://www.google.com">Descargar juego</a>
          </div>
        </div>
      </div>
    </section>
      ...
      <div class="container">
        <div class="row">
          <div class="col-lg-12 text-center">
            ...
            <h3 class="section-subheading text-muted">Los desarrolladores</h3>
          </div>
        </div>
        <div class="row">
          <div class="col-sm-3">
          ...
          <div class="col-sm-3">
            <div class="team-member">
              <img class="mx-auto rounded-circle" src="img/team/joseito.jpeg" alt="">
              <h4>Joseito Perez Caamal</h4>
              <p class="text-muted">Heil Hitler</p>
              <ul class="list-inline social-buttons">
                <li class="list-inline-item">
                  <a href="#">
                    <i class="fa fa-twitter"></i>
        ...
        <div class="row">
          <div class="col-lg-8 mx-auto text-center">
            <p class="large text-muted">Nuestro equipo bien vergas de diseñadores está conformado por
              cada uno .</p>
          </div>
        </div>
      </div>
            ...
            <div class="row">
              <div class="col-lg-8 mx-auto">
                <div class="modal-body">
                  ...
                  <img class="img-fluid d-block mx-auto" src="img/portfolio/2018-04-16 (1).png" alt="">
                  ...
                  <p class="item-intro text-muted">Aquí te mostramos un poco de como se debería jugar.</p>
                  <img class="img-fluid d-block mx-auto" src="img/portfolio/2018-04-16 (3).png" alt="">
            ...
            <div class="row">
              <div class="col-lg-8 mx-auto">
                <div class="modal-body">
                  ...
                  <p>Es un candyman que vive en una aldea de dulce amenamente, él cosecha sunchos en el bosque
                    pero un día se encontró con robots que lo estuvieron persiguiendo debido a eso se perdió 
                    en el bosque al momento de regresar a su casa o eso es lo que el creía...
                    Se encontró una cabaña en el bosque y decidió encontrarse a ella para pedir ayuda porque 
                    no sabía donde estaba pero en ves de encontrar la ayuda que el deseaba, se encontró con el robot, intentó correr hacia la cabaña para refugiarse pero no lo logró, él sin darse cuenta fue asesinado por el robot, y por el azares del destino fue enviado al infierno, a su dulce a inferno... </p>
